...
private:
    ...
    static void general_security_changed_cb(struct bt_conn *conn, bt_security_t level, enum bt_security_err err);
...
protected:
    ...
    virtual void on_security_changed(struct bt_conn *conn, bt_security_t level, enum bt_security_err err) = 0;
};
